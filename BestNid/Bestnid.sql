...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2015 a las 18:00:11
...
ALTER TABLE `registrado`
 ADD PRIMARY KEY (`email`), ADD UNIQUE KEY `dni` (`dni`), ADD UNIQUE KEY `localidad` (`localidad`), ADD UNIQUE KEY `tarjeta` (`tarjeta`);
...
ADD CONSTRAINT `registrado_ibfk_2` FOREIGN KEY (`localidad`) REFERENCES `localidad` (`idLocalidad`),
