<?php
	...
	if ($nombre == "vacio"){
		...
		$tienePublicaciones = cantidadPublicacionesCategoria($_POST["categoria"]);
		if ($tienePublicaciones){
			$_SESSION["exito"] = "<div class='alert alert-danger'><p style='color: green ; text-align: center'>La categoria posee publicaciones. No puede ser eliminada!</p></div>";
		}
		else {
