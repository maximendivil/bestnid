...
<?php
	...
	if (count($resultado)>0){
		...
		echo "<div class='alert alert-danger'><p style='text-align: center'>No se han encontrado publicaciones que contengan ese título. Por favor intente realizando otra busqueda</p></div>";
	}
?>
