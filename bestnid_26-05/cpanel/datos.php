<script language="javascript" charset="ISO-8859-1">     
            ...
            function obtener_provincias(code){
                var url = "http://localhost/consulta_provincias.php?code=" + code;
                var provincias = $.ajax({
                        url: url,
                        type: 'GET'
            ...
            <form class="form-horizontal" style="padding-top: 2em" method="POST" action="<?php echo $_SERVER["PHP_SELF"];?>">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input id="fechaNac" name="fechaNac" type="date" placeholder="Formato: dd/mm/yy" class="form-control input-md" value="<?php echo $fechaNacimiento ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input id="dni" name="dni" type="number" placeholder="Escribe tu DNI aqui sin utilizar puntos. Por ej: 12345678" class="form-control input-md" value="<?php echo $dni ?>" required>
