        ...
        <div class="row">
                ...
                <?php
                    ...
                    if (count($resultado)>0){
                        ...
                        echo "</div>";
                        echo "<div class='row'>";
                        echo "<p><a href='mostrar_publicaciones.php?pagina' style='text-decoration:none'><button class='btn btn-primary center-block' style='margin-top: 50px'>Ver mas publicaciones</button></a></p>";
                        echo "</div>";
                    }
                    else {                        
