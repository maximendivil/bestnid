...
<div class="container">
        <div class="row">
            ...
            <a href="javascript:history.back()" style="text-decoration: none"><button class="btn btn-lg btn-warning center-block" style="padding-left: 15% ; padding-right: 15%">Volver</button></a>
        </div>
    </div>