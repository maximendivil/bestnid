...
<div>
    ...
    <div class="container">
    	<div class="row">
		    ...
		    <a href="eliminar_registrado_db.php?email=<?php echo $_SESSION['usuario'];?>" style="text-decoration: none"><button class="btn btn-lg btn-warning center-block" style="padding-left: 5% ; padding-right: 5% ; float: left ; margin-right: 20px">Eliminar</button></a>
