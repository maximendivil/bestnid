		...
		<?php
			...
			if (count($rows)>0){
				for ($i=0; $i < count($rows); $i++) { 
					...
					echo "<td><a href='publicacion.php?id=$idPublicacion' data-toggle='tooltip' title='Ver publicacion'><span class='glyphicon glyphicon-search'></span></a> <a href='republicar.php?idPublicacion=$idPublicacion' data-toggle='tooltip' title='Republicar'><span class='glyphicon glyphicon-repeat'></span></a> ";
					echo "<a href='ver_ganadora.php?id=".$idPublicacion."' title='Ver oferta ganadora'><span class='glyphicon glyphicon-heart'></span></a></td>";
					echo "</tr>";	
				}
