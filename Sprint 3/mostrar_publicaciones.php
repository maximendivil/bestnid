...
<div class="container col-md-8">
        ...
        <div class="row">
        	...
        	<?php
    			...
    			$resultado = publicacionesPaginadas($inicio,$TAMANO_PAGINA);
				...
				if (count($resultado)>0){
					...
					if ($total_paginas > 1) {
					   	if ($pagina != 1){
					    	echo "<div class='col-md-6'><ul class='pager'><li class='previous'><a href=mostrar_publicaciones.php?pagina=".($pagina-1)."'>Anterior</a></li></ul></div>";
					    }
					    else {
					    	echo "<div class='col-md-6'><ul class='pager'><li class='previous disabled'><a href='#'>Anterior</a></li></ul></div>";
					    }
					    if ($pagina != $total_paginas){
					    	echo "<div class='col-md-6'><ul class='pager'><li class='next'><a href='mostrar_publicaciones.php?pagina=".($pagina+1)."'>Siguiente</a></li></ul></div>";
					    }
					    else {
